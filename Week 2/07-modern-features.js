...
//My Attempt
/* let first = Number(prompt("Enter 1st array value:"));
let second =  Number(prompt("Enter 2nd array value:"));
let third =  Number(prompt("Enter 3rd array value:"));
let fourth =  Number(prompt("Enter 4th array value:"));
let fifth =  Number(prompt("Enter 5th array value:"));

let array = [];
function findMax (f,s,t,fo,fi) {
    
    return array = [f,s,t,fo,fi];
    console.log(array);
}

findMax(first,second,third,fourth,fifth);
console.log(array);
console.log("The largest value in the array is:",Math.max(array); */
...
//objects are property and value pairs
